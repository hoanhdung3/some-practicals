class Employee:
    ...
    @staticmethod
    def is_workday(day): # staticmethod don't take the instance or class at first argument 
        if day.weekday() == 5 or day.weekday() == 6:
            return False
        return True

emp1 = Employee('Anh', 'Dung', 12345)
emp2 = Employee('Minatozaki', 'Sana', 50000)

# Employee.set_raise_amt(1.07)

# emp1.raise_amt = 1.07 # Use this only change the raise amount of emp1
# emp1.set_raise_amt(1.07) # Use this change entire raise amount
...
emp_str_1 = 'Paul-Pogba-1000'
emp_str_2 = 'Harry-Maguire-2000'
emp_str_3 = 'Jadon-Sancho-3000'

emp3 = Employee.from_string(emp_str_1)
print(emp3.email)

import datetime
my_date = datetime.date(2022, 5, 10)
