...
void draw_line(int n,const char* ch);
void board();
...
int main()
{
    int player1 = 0, player2 = 0, last_position;
    char player1_name[80], player2_name[80];
    system("clear"); // clrsrc()
    random_r();
    draw_line(50,"=");
    cout<<"\n\n\n\n\t\tSNAKE LADDER GAME\n\n\n\n";
    ...
    while(player1 <= 100 && player2 <= 100 )
    {
        ...
        cout<<"\n\n--->"<<player1_name<<" Now tyour turn >> Press any key to play ";
        getch();
        last_position = player1;
        play_dice(player1);
        if(player1 < last_position)
            cout << "\n\aOops!! Snake found !! You are at postion " << player1 << "\n";
        else if(player1 > last_position +6)
            cout << "\nGreat!! you got a ladder !! You are at position " << player1;
        cout << "\n\n--->" << player2_name << " Now your Turn >> Press any key to play ";
        getch();
        last_position = player2;
        play_dice(player2);
        if (player2 < last_position)
            cout << "\n\n\aOops!! Snake found !! You are at position " << player2 << "\n";
        else if (player2 > last_position + 6)
